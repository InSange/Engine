...
#pragma endregion
	...
	void LoadShaders()
	{
		...
		Resources::Load<graphics::Shader>(L"Sprite-Default-Shader", L"..\\Shader_Source\\Sprite-Default");
	}

	void LoadMaterials()
	{
		Material* triangleMaterial = new Material();
		triangleMaterial->SetShader(NuNu::Resources::Find<graphics::Shader>(L"TriangleShader"));

		NuNu::Resources::Insert(L"TriangleMaterial", triangleMaterial);
		...
		spriteMaterial->SetShader(NuNu::Resources::Find<graphics::Shader>(L"Sprite-Default-Shader"));

		NuNu::Resources::Insert(L"Sprite-Default-Material", spriteMaterial);
